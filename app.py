...
# App Insights Integration Settings
AZURE_APP_INSIGHTS_INSTRUMENTATION_KEY = os.environ.get("APP_INSIGHTS_INSTRUMENTATION_KEY")
        ...
        "dataSources": [
            {
                ...
                "parameters": {
                    "endpoint": f"https://aikennedy.co.uk/searchendpoint",
...
def conversation():
    ...
    if AZURE_APP_INSIGHTS_INSTRUMENTATION_KEY:
        ...
        tc.track_event('Chatbot response', { 'prompt': json.dumps(request_body), 'response': conversation_internal_output.data.decode() })
        tc.flush()
